      ...
      <div style={{
        ...
        {isStreaming && (
          <span style={{
            ...
            background: '#00b4d8', marginLeft: '4px', borderRadius: '2px',
            animation: 'pulse 0.8s ease infinite', verticalAlign: 'middle',
          }} />
        )}
      </div>
    </div>
  ...
  return (
    <div style={{ display: 'flex', height: '100vh', background: '#0a1628', fontFamily: "'DM Sans', sans-serif" }}>
      <div style={{ width: '420px', minWidth: '380px', display: 'flex', flexDirection: 'column', borderRight: '1px solid rgba(0,180,216,0.15)', background: 'rgba(10,22,40,0.95)' }}>
        <div style={{ padding: '20px 24px', borderBottom: '1px solid rgba(0,180,216,0.15)', background: 'rgba(17,34,64,0.6)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            <div style={{ width: 42, height: 42, borderRadius: '12px', background: 'linear-gradient(135deg, #00b4d8, #0077b6)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '22px' }}>🧭</div>
            <div>
              <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: '22px', fontWeight: 700, color: '#e8f4f8' }}>VONTREK</h1>
              <p style={{ fontSize: '11px', color: '#00b4d8', letterSpacing: '2px', textTransform: 'uppercase' }}>Tu aventura comienza aquí</p>
            </div>
          </div>
        </div>
